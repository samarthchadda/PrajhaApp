...
export class TrainingService {
  ...
  {
    return this.http.get('https://prajhaapp.herokuapp.com/api/get-training-categories');
  } 
  
  postTrainingCategories(data)
  {
    return this.http.post('https://prajhaapp.herokuapp.com/api/post-training-category',data);
  } 
